// functor.cpp -- použití funktoru
#include <iostream>
#include <list>
#include <iterator>

template<class T> // functorová tøída definuje operator()()
class TooBig
{
private:
	T cutoff;
...
int main()
{
	...
	cout << endl;
	yadayada.remove_if(f100); // použití pojmenovaného funkèního objektu
	etcetera.remove_if(TooBig<int>(200)); // konstrukce funkèního objektu
